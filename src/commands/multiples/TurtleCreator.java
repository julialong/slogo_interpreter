 ...
 * @author benhubsch
 * 
 *         This is an abstract class that both Tell and Ask implement and
 *         abstracts out the main concepts that exist surrounding those two
 *         Commands.
 *
 */
public abstract class TurtleCreator extends Multiple {
	...
	public TurtleCreator(Visualizer vis, VariableReplacer var_replacer, int num_args, List<String> actives,
